# Google搜尋器
這是一款使用Java寫的Android APP，可以用他來查詢Google，可直接連線到Google，目前也正在維護中，也有在定時更新。<br>
目前功能:<br>
查Google
...
**Step 1.**``git clone https://github.com/mmm25002500/webGoogle``
...
### 心得與建構思路:
此專案是我在上課時聽從老師講解而想到的學英文APP,就是在 Appinventor 上進行練習編寫
